...
| Framework version | Publication revision | Status | English | 中文 | Canonical publication |
|---|---:|---|---|---|---|
...
Zenodo record `20711332` is retained as a separate earlier Human Function publication. It is not the canonical publication for UOHF V1.0 and is not used as a substitute DOI for any UOHF version listed above.

Zenodo 记录 `20711332` 作为更早期的人体功能论文独立保留。它不是 UOHF V1.0 的权威出版记录，也不得替代上述任何 UOHF 版本的 DOI。
