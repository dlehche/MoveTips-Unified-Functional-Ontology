...
UOHF does not primarily seek to add another disease classification, movement taxonomy, or intervention catalogue. Its central question is:
...
9.  How does UOHF relate to existing classifications, ontologies, and professional systems?

10. What does UOHF unify, and what does it explicitly not unify?

## 2. Aim, Method, and Scope of Argument

### 2.1 Aim

The aim of this paper is to establish a stable, interpretable, and formalisable conceptual framework for unification in UOHF. The framework must satisfy four requirements:

1.  It must state what UOHF directly unifies.
...
2.  Internal consistency review of existing UOHF definitions, relation rules, and working documents.
...
Disciplinary categories are divisions in human knowledge and work; they are not divisions in the body’s existence. UOHF must therefore begin from the following commitment:
...
UOHF is consequently not a database into which existing disciplinary lists are placed side by side. It must re-establish objects and relations from the standpoint of the whole person, so that disease, structure, process, function, demand, engagement, state, and change can all refer to the same individual.

### 3.1 Reality, Epistemic, and Application Layers

To avoid conflating the body itself, judgments about the body, and actions intended to change the body, UOHF must distinguish at least three layers.
