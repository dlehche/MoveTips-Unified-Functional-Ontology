...
3. [Root definition, formal commitments, and formal objects](source/en/02-root-definition-formal-objects.md)
4. [Axioms and demand-bounded realizability](source/en/03-axioms-and-demand-bounded-realizability.md)
5. [Problem hypotheses, evidence status, and result non-identifiability](source/en/04-hypotheses-non-identifiability.md)
6. [Anchors, governed action, and longitudinal update](source/en/05-anchors-decision-longitudinal-update.md)
7. [Worked external- and internal-demand examples](source/en/06-worked-examples.md)
8. [Implementation-oriented architecture and research program](source/en/07-implementation-and-research-program.md)
9. [Falsifiability, discussion, limitations, and conclusion](source/en/08-falsifiability-discussion-limitations-conclusion.md)
